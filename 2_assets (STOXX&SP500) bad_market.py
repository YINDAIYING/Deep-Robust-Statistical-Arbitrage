...
print(dates[0])
print(dates[test_begin_day-1])
print(dates[test_begin_day])
print(dates[test_end_day])

print('Test begin day:'+str(test_begin_day))
print('Test end day:' +str(test_end_day))
