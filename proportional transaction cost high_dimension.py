# -*- coding: utf-8 -*-
"""10_assets_proportional.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-ML5zJ3hh-Y0MrGUIhzmUQQYHvWH16Pw
"""
...
def stat_arb_success_buy_and_hold_only_once(stock_test):
    pnl = 0
    for k in range(z):
        pnl += (10*(stock_test[k][-1]-stock_test[k][0])-trans_cost*10*stock_test[k][0]-trans_cost*10*stock_test[k][-1])
