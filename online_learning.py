# -*- coding: utf-8 -*-
"""Online Learning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gGgqvm8pCP3nptx9rbZ_18Awl9LWfOL2
"""
...
def stat_arb_success(stock_test, net, optimizer):
    ...
    iter = int(len(stock_test[0])/10)

    for i in range(iter):

        print("Online Epoch", i)
        ...
        upper_bound_list = [delta.clone().detach().cpu().numpy()[0] for delta in upper_bound]
        ...
        stock_train = [asset[:test_begin_day+(i+1)*10] for asset in asset_list]
...
for trial in range(trials):
  ...
  if i==0:
    continue
  net.eval()
  record = stat_arb_success(stock_test, net, optimizer)
