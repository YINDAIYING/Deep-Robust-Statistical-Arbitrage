# -*- coding: utf-8 -*-
"""2_assets_bad.ipynb（副本）（副本）

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_BLzKiqQGwA6wXJHN7EG7xWGvVxeuroj
"""



# -*- coding: utf-8 -*-
"""example2_30_assets_250_iter

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1BX7F9wRo8AW2cpT_GLRUl-ivazSf-39_
"""
...
Original file is located at
    https://colab.research.google.com/drive/1U_sngHWcXr_iGAwttgqs7sdp6jSNW-zC
"""
...
# dates = dates[2014:len(dates)-79]
# stoxx = stoxx[2014:len(stoxx)-79]
# SP = SP[2014:len(SP)-79]
...
def get_indicator_matrix(partition, S_n):
    ...
    for i in range(len(S_n)):
      ...
      for j in range(z):
        temp = temp&((partition[:,2*j]<S_n[i,j])&(partition[:,2*j+1]>=S_n[i,j]))
      temp = temp.flatten()
...
# rescaled_lower_bounds = 100*stock_mins/stock_maxs
# rescaled_upper_bounds = 100*stock_maxs/stock_mins
